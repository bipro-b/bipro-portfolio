        ...
        <Container className="banner">
            <div className="row ">
                <div className="col-lg-6 first-part">
                    ...
                    <h4>I am a junior rect developer.</h4>
                    ...
                    <button style={{ backgroundColor: '#707a84' }} className="rounded  m-3"> <a style={{ textDecoration: 'none', color: 'white' }} href="https://drive.google.com/file/d/1o-FH0L_sIs8YU2CShTJ058wJb--P_5mU/view" target="_blank" rel="noreferrer">Resume</a></button>
